...
function streamStart() {
  ...
  // Load custom streamer game names
  var _cn = window._customGameNames || {};
  var _sn = function(key, fallback) { return _cn['S_'+key+'_name'] || fallback; };
  var _sd = function(key, fallback) { return _cn['S_'+key+'_desc'] || fallback; };
